...
One leading family of deep generative models are the variational auto-encoders \cite{kingma2019vae}\cite{}, which use special choices of parameterization or generator structures to preserve the likelihood computation. A pre-defined inference task can still be carried out and sampling is also efficient in variational auto-encoders. In learning, these models are sensitive to the Monte Carlo estimation of the gradients, \textcolor{blue}{add variance issue analysis}
