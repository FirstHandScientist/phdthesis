...
% \begin{figure}
%   \centering
%   \input{images/diagram/emgm-nm.tex}
...
We use feed-forward neural network to implement every generator. With some notational abuse, assume that $\tilde{\bm{g}}$ is a feed-forward neural network:
$\tilde{\bm{x}}=\tilde{\bm{g}}(\bm{z})$ that has multiple hidden layers
$\tilde{\bm{g}}=\tilde{\bm{g}}^{[L]}\circ \tilde{\bm{g}}^{[L-1]}\circ \cdots
\circ \tilde{\bm{g}}^{[1]}$ and is invertible $\tilde{\bm{f}}=\tilde{\bm{g}}^{-1}$. Then the signal flow can be depicted as% , illustrated in \autoref{illustation}.
% $=\bm{h}_L(\bm{h}_{L-1}\hdots (\bm{h}_1(\bm{z})))$.
\begin{equation*}
  % \begin{figure}[htb]
  \vspace{-8pt}
  \centering
...
\end{equation*}
% \vspace{-15pt}
% \caption{$\tilde{\bm{g}}=\tilde{\bm{g}}_L\circ \tilde{\bm{g}}_{L-1}\circ \cdots \circ \tilde{\bm{g}}_1$ and $\tilde{\bm{f}}=\tilde{\bm{g}}^{-1}$.}
% \label{illustation}
% \end{equation}
% \end{figure}
...
\subsection{Latent mixture model}\label{subsec-latmm}
                  %                   \begin{figure}
                  %                   \centering
                  %                   \input{images/diagram/emgm-sm.tex}
...
\end{algorithm}
    ...
    %       \end{tikzpicture}
    %   %       \input{images/diagram/emgm-sm-gaussian.tex}
    %   %       \vspace{-5pt}
