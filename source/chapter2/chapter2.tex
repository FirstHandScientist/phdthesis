...
\end{align}
where $i \in a$ stands for the node $i$'s associated $x_i$ is argument of $\phi_{a}$.
...
\end{equation}
where $\mathrm{ne}_i = \left\{ a | i \in a, a \in \Ff \right\}$, i.e. the
