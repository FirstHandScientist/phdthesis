  ...
  \begin{tikzpicture}
    \node[black] (grad) at (0,0) {
      \begin{minipage}{1\linewidth}
        ...
        \item The two modules are not necessarily coupled, and each module may be replaced by another algorithm while the other one remains.\textcolor{blue}{may give overlap effect}
        \end{itemize}
      \end{minipage}
    };
