...
\begin{frame}{EOTGM: EOT based Generative Model}
  \begin{tikzpicture}
    ...
    \tikzstyle{elnode}=[draw, rectangle, rounded corners = 2pt, inner sep = 4pt, align=center]
    \tikzstyle{nnode} = [rectangle, rounded corners = 2pt,minimum size = 4.8cm,draw,inner sep = 2pt]
