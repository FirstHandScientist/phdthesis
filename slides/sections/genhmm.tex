...
\begin{frame}[label=current]
  ...
  \begin{tikzpicture}
    ...
    \end{scope}
    \draw[->, shorten >=10pt, shorten <=10pt] (genhmmTemplate) to [out=-120, in=180] (unroll);
...
\begin{frame}[label=current]{Learning Intuition}
    ...
    \begin{textblock}{5}(3,6)
      \begin{tikzpicture}[auto,rotate=-5,transform shape]
        ...
        {\begin{minipage}{1\textwidth}
            ...
            \item No optimality in M-step (NN generators).
...
\begin{frame}[label=current]{Application to Speech Recognition}
  Configuration of generators of GenHMM in Experiments on TIMIT
  \begin{table}
    \centering
