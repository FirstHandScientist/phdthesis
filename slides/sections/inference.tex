  ...
  \onslide<2->{
    ...
    \begin{tikzpicture}
      ...
      \begin{scope}[scale=0.8, every node/.append style={transform shape} ]
        ...
        \node[rnode, right=of r01] (r02) {\begin{tabular}[x]{@{}c@{}} Construct Region Graph\\ {\tiny Tree-robust conditon} \\ {\tiny $+$ Cluster Variation Method} \\ {\tiny $+$ Validity} \end{tabular}};
        \node[rnode, right=of r02] (r03) {\begin{tabular}{c}Free Energy Optimization\\ {\tiny Backpropagation}\\ {\tiny Gradient descent}\end{tabular}};
